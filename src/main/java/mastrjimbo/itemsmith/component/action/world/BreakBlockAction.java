...
/** Breaks the target block naturally, dropping its items as if mined. */
public final class BreakBlockAction implements Action {
    ...
    @Override public String displayName() { return "Break Block"; }
    @Override public String description() { return "Breaks the target block, dropping its items."; }

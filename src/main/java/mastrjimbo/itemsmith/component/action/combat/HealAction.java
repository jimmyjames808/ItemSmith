...
/** Restores health to the target, capped at its maximum-health attribute. No-op for non-living targets. */
public final class HealAction implements Action {
    ...
    private static final ParamSchema SCHEMA = ParamSchema.builder()
            .add(ParamDef.of("amount", ParamType.DOUBLE, 4.0)
                    .label("Heal amount").min(0).desc("Health restored (2.0 = 1 heart)."))
            .build();

    @Override public String id() { return ID; }
    @Override public String category() { return Categories.COMBAT; }
    @Override public String displayName() { return "Heal"; }
    @Override public String description() { return "Restores health to the target (up to its max)."; }

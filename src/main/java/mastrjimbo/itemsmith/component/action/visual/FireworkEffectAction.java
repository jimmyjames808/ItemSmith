...
/** Spawns a firework at the target's location that detonates immediately as a cosmetic flash. */
public final class FireworkEffectAction implements Action {

    public static final String ID = "firework_effect";

    private static final ParamSchema SCHEMA = ParamSchema.builder()
            .add(ParamDef.of("color", ParamType.STRING, "red")
    ...
    @Override public String displayName() { return "Firework Effect"; }
    @Override public String description() { return "Detonates a colored firework flash at the target's location."; }
    ...
    public void run(AbilityContext ctx, Object target, ParamValues params) {
        ...
        World w = l.getWorld();
        if (w == null) return;
        String color = params.getString("color", "red");
        String type = params.getString("shape", "BALL");

        Firework fw = (Firework) w.spawnEntity(l, EntityType.FIREWORK_ROCKET);
        // Tag it so FireworkListener vetoes the blast damage — keeps it cosmetic. (The launch/blast
        // SOUNDS are positional world sounds Bukkit can't mute; they're inherent to a firework.)

...
/** Passes when the caster's Vault balance is strictly above the given amount. Passes without economy. */
public final class BalanceAboveCondition implements Condition {

    public static final String ID = "balance_above";

    private static final ParamSchema SCHEMA = ParamSchema.builder()
            .add(ParamDef.of("amount", ParamType.DOUBLE, 100.0)
                    .label("Amount").min(0).desc("Balance must be above this."))
            .build();

    @Override public String id() { return ID; }
    @Override public String category() { return Categories.CONDITION; }
    @Override public String displayName() { return "Balance Above"; }
    @Override public String description() { return "True when the caster's balance is above the amount."; }

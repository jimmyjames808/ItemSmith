...
/** Every hostile monster within a radius of the caster. */
public final class NearbyMonstersTargeter implements Targeter {

    public static final String ID = "nearby_monsters";
    ...
    public String description() {
        return "All hostile monsters within a radius of the caster.";
    }

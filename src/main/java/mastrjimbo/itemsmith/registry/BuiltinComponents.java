...
import mastrjimbo.itemsmith.component.action.movement.GrappleAction;
import mastrjimbo.itemsmith.component.action.movement.ImplodeAction;
import mastrjimbo.itemsmith.component.action.movement.PullSelfAction;
...
public final class BuiltinComponents {
    ...
    private static void registerActions(Registries r) {
        ...
        r.register(new PullSelfAction());
        r.register(new GrappleAction());
        r.register(new ImplodeAction());
